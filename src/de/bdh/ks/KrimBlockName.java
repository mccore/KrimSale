...
public class KrimBlockName 
{
	...
	public KrimBlockName()
	{
		...
		if(configManager.brautec == 1)
		{
			...
			names.put("tinignot","1257:4");
			names.put("silverignot","1257:3");
			names.put("sapphire","1257:2");
			names.put("emerald","1257:1");
			names.put("ruby","1257");
			names.put("copperignot","1257:5");
			names.put("nicolite","1257:6");
