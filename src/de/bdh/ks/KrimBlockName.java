...
public class KrimBlockName 
{
	...
	public KrimBlockName()
	{
		//INIT VALUES
		names.put("air", "0");
		names.put("stone,stein","1");
		names.put("grassblock,grasblock","2");
		names.put("dirt,erde","3");
		names.put("cobbelstone,pflasterstein","4");
		names.put("woodenplanks,bretter","5");
		names.put("woodenplanks,bretter","5:1");
		names.put("woodenplanks,bretter","5:2");
		names.put("woodenplanks,bretter","5:3");
		names.put("sapling,setzling","6");
		names.put("sapling,setzling","6:1");
		names.put("sapling,setzling","6:2");
		names.put("sapling,setzling","6:3");
		names.put("bedrock,grundgestein","7");
		names.put("watersource,watersource","8");
		names.put("waterstill,waterstill","9");
		names.put("lavasource,lavasource","10");
		names.put("lavastill,lavastill","11");
		names.put("sand,sand","12");
		names.put("gravel,kies","13");
		names.put("goldore,golderz","14");
		names.put("ironore,eisenerz","15");
		names.put("coalore,kohleflöz","16");
		names.put("wood,holz","17");
		names.put("holz","17:1");
		names.put("holz","17:2");
		names.put("holz","17:3");
		names.put("leaves","18");
		names.put("leaves","18:1");
		names.put("leaves","18:2");
		names.put("sponge,schwamm","19");
		names.put("glass,glas","20");
		names.put("lapislazuliore,lapislazuli-erz","21");
		names.put("lapislazuliblock,lapislazuli-block","22");
		names.put("dispenser,spender","23");
		names.put("sandstone,sandstein","24");
		names.put("sandstone,sandstein","24:1");
		names.put("sandstone,sandstein","24:2");
		names.put("noteblock,notenblock","25");
		names.put("poweredtrack,poweredtrack","27");
		names.put("detectortrack,detectortrack","28");
		names.put("stickypiston,klebrigerkolben","29");
		names.put("cobweb,spinnweben","30");
		names.put("grass,gras","31:1");
		names.put("fern,farn","31:2");
		...
		names.put("lightgraywool,hellgrauewolle","35:8");
		names.put("cyanwool,türkisewolle","35:9");
		names.put("purplewool,violettewolle","35:10");
		names.put("bluewool,blauewolle","35:11");
		names.put("brownwool,braunewolle","35:12");
		names.put("greenwool,grünewolle","35:13");
		names.put("redwool,rotewolle","35:14");
		names.put("blackwool,schwarzewolle","35:15");
		names.put("flower,blume","37");
		names.put("rose,rose","38");
		names.put("mushroom,pilz","39");
		names.put("mushroom,pilz","40");
		names.put("blockofgold,goldblock","41");
		names.put("blockofiron,eisenblock","42");
		names.put("doubleslab,doubleslab","43");
		names.put("doublesandstoneslab,doublesandstoneslab","43:1");
		names.put("doublewoodenslab,doublewoodenslab","43:2");
		names.put("doublecobbelstoneslab,doublecobbelstoneslab","43:3");
		names.put("doublebricksslab,doublebricksslab","43:4");
		names.put("doublestonebricksslab,doublestonebricksslab","43:5");
		names.put("stoneslab,steinstufe","44");
		names.put("sandstoneslab,sandsteinstufe","44:1");
		names.put("woodenslab,holzstufe","44:2");
		names.put("coobelstoneslab,pflastersteinstufe","44:3");
		names.put("bricksslab,ziegelstufe","44:4");
		names.put("stonebricksslab,steinziegelstufe","44:5");
		names.put("bricks,ziegelstein","45");
		names.put("tnt,tnt","46");
		names.put("bookshelf,bücherregal","47");
		names.put("mossstone,bemoosterstein","48");
		names.put("obsidian,obsidian","49");
		names.put("torch,fackel","50");
		names.put("fire,feuer","51");
		...
		names.put("woodenstairs,holztreppe","53");
		names.put("chest,truhe","54");
		names.put("diamondore,diamanterz","56");
		names.put("blockofdiamond,diamantblock","57");
		names.put("craftingtable,werkbank","58");
		names.put("farmland,ackerboden","60");
		names.put("furnace,ofen","61");
		names.put("furnace,ofen","62");
		names.put("ladder,leiter","65");
		names.put("track,track","66");
		names.put("stonestairs,steintreppe","67");
		names.put("lever,schalter","69");
		names.put("pressureplate,druckplatte","70");
		names.put("pressureplate,druckplatte","72");
		names.put("redstoneore,rotstein-erz","73");
		names.put("redstonetorch,rotstein-fackel","76");
		names.put("button,knopf","77");
		names.put("snow,schnee","78");
		names.put("ice,eis","79");
		names.put("snow,schnee","80");
		names.put("cactus,kaktus","81");
		names.put("clay,lehm","82");
		names.put("jukebox,plattenspieler","84");
		names.put("fence,zaun","85");
		names.put("pumpkin,kürbis","86");
		names.put("netherrack,netherstein","87");
		names.put("soulsand,seelensand","88");
		names.put("glowstone,leuchtstein","89");
		names.put("portal,portal","90");
		names.put("jack‘o’lantern,kürbislaterne","91");
		names.put("cake,kuchen","92");
		names.put("lookedchest,verschlossenetruhe","95");
		names.put("trapdoor,falltür","96");
		names.put("silverfishstone,silverfishstone","97");
		names.put("stonebricks,steinziegel","98");
		names.put("stonebricks,steinziegel","98:1");
		names.put("stonebricks,steinziegel","98:2");
		names.put("stonebricks,steinziegel","98:3");
		names.put("mushroom,pilz","99");
		names.put("mushroom,pilz","100");
		names.put("ironbars,eisengitter","101");
		names.put("glasspanel,glasscheibe","102");
		names.put("melon,melone","103");
		names.put("vines,ranken","106");
		names.put("fencegate,zauntor","107");
		names.put("brickstairs,ziegeltreppe","108");
		names.put("stonebricksatirs,steinziegeltreppe","109");
		names.put("mycelium,mycelium","110");
		names.put("lilypad,seerosenblatt","111");
		names.put("netherbrick,netherziegel","112");
		names.put("netherbrickfence,netherzaun","113");
		names.put("netherbrickstairs,netherziegelstufen","114");
		names.put("netherwart,netherwarze","115");
		names.put("enchantmenttable,zaubertisch","116");
		names.put("endportal,endportal","119");
		names.put("endportalframe,endportalframe","120");
		names.put("whitestone,whitestone","121");
		names.put("enderstein","121:1endstone");
		names.put("dragonegg,drachenei","122");
		names.put("redstonelamp,rotstein-lampe","123");
		names.put("redstonelamp,rotstein-lampe","124");
		...
		names.put("projecttable,projekttisch","137:3");
		names.put("blulectricalloyfurnance","137:4");
		names.put("duel-headblocksignal","138:1");
		names.put("switchmotor,wechselmotor","138:2");
		names.put("blocksignal","138:3");
		names.put("switchlever,wechselschalter","138:4");
		names.put("woodenpost","138:5");
		names.put("stonepost","138:6");
		names.put("signalreceiverbox,signalempfangsbox","138:8");
		names.put("signalcontrollerbox,signalkontrollbox","138:9");
		names.put("distantsignal","138:10");
		names.put("indigoflower","139");
		names.put("rubbersapling","139:1");
		names.put("rubyore,rubinerz","140");
		names.put("emeraldore,smarragderz","140:1");
		names.put("sapphireore,saphirerz","140:2");
		names.put("silverore,silbererz","140:3");
		names.put("tinore,zinnerz","140:4");
		names.put("copperore,kupfererz","140:5");
		names.put("tungstenore,wolframerz","140:6");
		names.put("nikoliteore,nikoliteerz","140:7");
		names.put("leaves,blätter","141");
		names.put("marble,marmor","142");
		names.put("basalt,basalt","142:1");
		names.put("marblebrick,","142:2");
		names.put("basaltcobblestone","142:3");
		names.put("basaltbrick","142:4");
		names.put("rubberwood","143");
		names.put("miningwell,bergbaubohrer","150");
		names.put("miningpipe,bergbauleitung","151");
		names.put("automaticcraftingtable,automatischewerkbank","152");
		names.put("quarry,quarry","153");
